...
export const metadata: Metadata = {
  title: "Resume",
  description:
    "The short version: where I've worked, what I've built, and what I actually know.",
    ...
    <section className="mx-auto max-w-3xl px-6 py-24 sm:py-32">
      <Reveal>
        ...
        <p className="mt-6 max-w-xl text-lg text-muted balance">
          Case studies are more fun. This is the boring-but-important part,
          for whoever needs it in this format.
        </p>
      </Reveal>

      <RevealGroup className="mt-16 flex flex-col gap-12" stagger={0.06}>
        {roles.map((role) => (
          <RevealItem key={role.company}>
            <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-b border-border pb-3">
              <h2 className="font-display text-xl">{role.company}</h2>
