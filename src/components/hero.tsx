...
const headline = ["Interfaces", "that move", "like they mean it."];
    ...
    <section className="mx-auto max-w-5xl px-6 pt-28 pb-20 sm:pt-40 sm:pb-28">
      {availability && (
        <motion.div
          ...
          className="mb-8 inline-flex items-center gap-2 rounded-full border border-border px-3 py-1 text-sm text-muted"
        >
